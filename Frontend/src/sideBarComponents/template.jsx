...
const EmailTemplate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:3000/create`, formDataToSend, {
        headers: {
  ...
  return (
    <>
      <div className="py-4 flex">
        <div className="border bg-white px-4 py-4 mx-6" style={{ width: "40rem" }}>
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="flex justify-end mt-6 space-x-4">
                <button type="button" className="px-6 py-2 bg-gray-200 rounded-md">
                  Cancel
                </button>
          ...
          <div className="flex flex-col border-gray-300">
            <div className="space-y-4 px-4">
              ...
              <div className="border border-gray-300 rounded-md px-4 p-4" style={{ width: "30rem" }}>
                <p className="text-gray-700">To: Example Contact &lt;example@google.com&gt;</p>
              ...
              <button className="w-full p-2 bg-blue-500 text-white rounded-md" onClick={handleSendTestEmail}>
