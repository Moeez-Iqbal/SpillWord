...
export const getEmailLists = async (req, res) => {
    try {
      ...
      const {
        Listname,
        industry, country, city, name, timezone,
        totalYearsOfExperience, timeInCurrentRole,
        sequence, lastActivity, emailSent,
        emailClicked, emailReplied, emailMeetingSet, emailBounced
      } = req.query;
